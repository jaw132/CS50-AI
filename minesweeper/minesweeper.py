    ...
    def add_knowledge(self, cell, count):
        ...
        for row in range(cell[0] - 1, cell[0] + 2):
            for col in range(cell[1] - 1, cell[1] + 2):
                ...
                # Ignore the cell itself
                if (row, col) == cell or (row, col) in self.safes:
                    continue
                ...
                if 0 <= row < self.height and 0 <= col < self.width:
                    surr_cell.add((row, col))

# minus the mines you have seen!!!
        self.knowledge.append(Sentence(surr_cell, count))
        ...
        for sentence1 in self.knowledge:
            for sentence2 in self.knowledge:
                if sentence1 != sentence2 and sentence1.cells.issubset(sentence2.cells):
                    ...
                    if Sentence(newSet, newCount) not in self.knowledge and Sentence(newSet, newCount) not in newKnowledge:
                        newKnowledge.append(Sentence(newSet, newCount))
